...
## Roadmap
**Fase 1** — ETL básico funcional (extract → transform → load)
**Fase 1.5** — Arquitectura Bronze/Silver/Gold, enriquecimiento de datos, transformaciones analíticas, 7 vistas Gold
